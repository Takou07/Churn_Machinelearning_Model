...
def train_model(df: pd.DataFrame, target_col: str):
    """
    Entraîne un modèle XGBoost et l'enregistre avec MLflow.

    Args:
        df (pd.DataFrame): Jeu de données de caractéristiques.
    ...
    with mlflow.start_run():
        ...
        # Enregistrer le jeu de données pour qu'il apparaisse dans l'interface utilisateur de MLflow
