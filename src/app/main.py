...
if __name__ == "__main__":
    print("🚀 Démarrage du serveur Churn Prediction (MODE DOCKER)...")
    print("👉 API Swagger : http://localhost:8001/docs")
    print("👉 Interface Web : http://localhost:8001/ui")
    
    # 0.0.0.0 est CRUCIAL : il autorise Docker à répondre aux requêtes externes
